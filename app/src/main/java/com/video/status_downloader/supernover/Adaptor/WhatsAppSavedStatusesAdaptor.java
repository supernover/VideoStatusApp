...
import com.video.status_downloader.supernover.Observer;
import com.video.status_downloader.supernover.R;
import com.video.status_downloader.supernover.Subject;
import com.video.status_downloader.supernover.Utills.Config;
import com.video.status_downloader.supernover.ViewerActivity.ImageViewerActivity;
import com.video.status_downloader.supernover.ViewerActivity.VIdeoViewerActivity;
...
public class WhatsAppSavedStatusesAdaptor extends RecyclerView.Adapter<WhatsAppSavedStatusesAdaptor.MyViewHolder> implements Subject {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        YoYo.with(Techniques.ZoomIn).playOn(holder.mCardView);
