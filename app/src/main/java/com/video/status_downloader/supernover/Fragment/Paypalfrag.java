...
public class Paypalfrag extends Fragment {
    ...
    //    currentPoint = (TextView) view.findViewById(R.id.userpoints);
        ...
        withdrawRequestsRef = FirebaseDatabase.getInstance().getReference("/WithdrawRequests/").child("PAYPAL");
        ...
        btngetpayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (balanceGT >= 7000) {
                    ...
                    TastyToast.makeText(getContext(), "your Balance Less than 7000", TastyToast.LENGTH_SHORT, TastyToast.ERROR);
                }
            }
        });
        return view;
